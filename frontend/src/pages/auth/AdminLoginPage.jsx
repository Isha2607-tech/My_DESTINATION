...
const AdminLoginPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            ...
            if (formData.email === 'admin@mydestination.in' && formData.password === 'admin123') {
                navigate('/admin/dashboard');
            } else {
                setError('Invalid credentials. Try admin@mydestination.in / admin123');
                setLoading(false);
            }
        }, 1500);
    };
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col items-center justify-center p-6">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400 text-sm">My DESTINATION Master Control</p>
                </div>
                ...
                >
                    ...
                    <div className="text-center text-slate-400 text-sm font-mono">
                        <p>Email: <span className="text-white">admin@mydestination.in</span></p>
