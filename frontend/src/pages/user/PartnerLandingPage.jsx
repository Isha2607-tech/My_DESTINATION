        ...
        <div className="min-h-screen bg-surface relative overflow-hidden text-white">
            ...
            <main className="relative z-10 p-6 flex flex-col min-h-screen">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <span className="text-sm font-bold tracking-widest text-white/70 uppercase">My DESTINATION Partner</span>
                </div>
                ...
                <div className="flex-1 flex flex-col justify-center pb-20">
                    ...
                    >
                        ...
                        <p className="text-white/80 text-lg leading-relaxed max-w-sm">
                            Join thousands of hotels and homeowners who trust My DESTINATION to increase their revenue.
                        </p>
                    </motion.div>
