        ...
        <div className="max-w-4xl mx-auto px-4 pt-10 pb-6">
          ...
          <div className="flex items-center gap-6 text-xs md:text-sm text-slate-400 mb-10 border-b border-slate-800 pb-10">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-linear-to-br from-emerald-500 to-sky-600 flex items-center justify-center">
                <User size={14} className="text-slate-950" />
              </div>
              <span className="font-bold text-slate-300">My DESTINATION Editorial</span>
            </div>
            <div className="flex items-center gap-2">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="mt-20 pt-10 border-t border-slate-800">
          <div className="bg-slate-900/40 rounded-3xl p-8 border border-slate-800">
            <h4 className="text-lg font-bold mb-2">About My DESTINATION</h4>
            <p className="text-slate-400 text-sm leading-relaxed">
              We're a team of travellers, techies, and hospitality experts dedicated to making budget travel premium. Every story on My DESTINATION Hub is backed by real data and on-ground experiences.
            </p>
            <button 
