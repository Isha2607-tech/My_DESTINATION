...
const AboutPage = () => {
  ...
  const content = page?.content || 'My DESTINATION helps you discover, compare and book stays that match your style, from budget hostels to premium villas, with a mobile-first experience.';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-surface text-white p-6 pb-10 rounded-b-[30px] shadow-lg sticky top-0 z-20">
        ...
        <p className="text-xs text-white/70 max-w-xs">
          Learn more about the story, mission and values behind My DESTINATION.
        </p>
      </div>
