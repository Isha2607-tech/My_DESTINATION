                                ...
                                <div className="flex items-start justify-between relative z-10">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <button
                                            ...
                                            className="p-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors backdrop-blur-sm shadow-sm"
                                            title="Profile Settings"
                                        >
                                            <Edit3 size={16} className="text-teal-100" />
                                        </button>
                                        <button
                                            onClick={handleLogout}
                                            className="p-2 rounded-lg bg-red-500/20 hover:bg-red-500/40 transition-all backdrop-blur-sm border border-white/10 shadow-sm"
                                            title="Logout"
                                        >
