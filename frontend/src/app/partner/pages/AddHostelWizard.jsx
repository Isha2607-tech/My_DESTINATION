...
const AddHostelWizard = () => {
  ...
  // --- Persistence Logic ---
  const STORAGE_KEY = `mydestination_hostel_wizard_draft_${existingProperty?._id || 'new'}`;
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <style>{`
        .btn-primary { background: var(--color-surface); color: white; font-weight: 700; padding: 10px 16px; border-radius: 12px; transition: transform 0.1s, background 0.1s; display: inline-flex; align-items: center; justify-content: center; gap: 8px; }
