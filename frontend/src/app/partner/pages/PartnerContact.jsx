      ...
      <main ref={contentRef} className="max-w-3xl mx-auto px-4 pt-6 space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-[var(--color-surface)]/10 flex items-center justify-center text-[var(--color-surface)]">
              <Mail size={18} />
            </div>
            <div>
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center gap-3">
            ...
            <div>
              ...
              <a
                ...
                className="text-xs text-gray-500 hover:text-[var(--color-surface)] transition-colors"
              >
                6232314147
              </a>
            </div>
        ...
        >
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:ring-2 focus:ring-[var(--color-surface)]/60"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:ring-2 focus:ring-[var(--color-surface)]/60 resize-none"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full flex items-center justify-center gap-2 mt-2 bg-[var(--color-surface)] text-white py-3 rounded-xl text-sm font-bold active:scale-95 disabled:opacity-60 disabled:active:scale-100 transition-transform"
          >
            <Send size={16} />
