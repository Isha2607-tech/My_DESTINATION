        ...
        <div className="w-full bg-partner-bg overflow-x-hidden">
            ...
            <section className="relative min-h-[60vh] md:min-h-[90vh] flex flex-col justify-center items-center text-center px-4 pt-12 pb-12 md:pt-20 md:pb-20">
                <div className="max-w-4xl mx-auto z-10">
                    <h1 className="hero-title text-4xl md:text-7xl font-black text-partner-text-primary tracking-tight leading-[1.1] mb-4 md:mb-6">
                        Grow Your Revenue <br /> with <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-600 to-[var(--color-surface)]">My DESTINATION Hub</span>
                    </h1>
            ...
            <section className="py-12 md:py-24 px-0 md:px-12 max-w-7xl mx-auto">
                <div className="px-6 mb-8 md:mb-16 reveal">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-partner-text-primary">How My DESTINATION Hub Works</h2>
                </div>
                    ...
                    {[
                        ...
                        <div key={i} className="min-w-[260px] md:min-w-0 snap-center bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100 group cursor-default flex flex-col h-[360px] transition-transform duration-300 mobile-card-zoom relative">
                            ...
                            <div className="h-1/2 relative overflow-hidden">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-surface)]/60 to-transparent flex items-end p-5 justify-between">
                            ...
                            <div className="p-5 flex flex-col justify-center h-1/2 bg-white relative z-10">
                                ...
                                <div className="hidden md:block absolute bottom-0 left-0 w-0 h-1 bg-[var(--color-surface)] group-hover:w-full transition-all duration-500 ease-out" />

                                {/* Mobile Active Indicator (Always visible if active class present) */}
                                <div className="absolute bottom-0 left-0 w-full h-1 bg-[var(--color-surface)] opacity-0 transition-opacity duration-300 mobile-active-line md:hidden" />
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <style>{`
                @media (max-width: 768px) {
                    ...
                    .mobile-card-active { opacity: 1; transform: scale(1); border-color: var(--color-surface); box-shadow: 0 20px 25px -5px rgb(0 79 77 / 0.1); }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 reveal-stagger">
                        {[
                            ...
                            <div key={i} className="bg-white p-6 md:p-8 rounded-2xl md:rounded-3xl shadow-sm hover:shadow-xl transition-shadow border border-gray-100 flex md:block items-center gap-4 md:gap-0">
                                <div className="w-12 h-12 md:w-14 md:h-14 bg-[var(--color-surface)] text-white rounded-xl md:rounded-2xl flex items-center justify-center md:mb-6 shrink-0">
            ...
            <section className="py-12 md:py-24 px-4 md:px-12 max-w-5xl mx-auto reveal">
                <div className="bg-[var(--color-surface)] text-white rounded-3xl md:rounded-[2.5rem] p-8 md:p-16 text-center shadow-xl relative overflow-hidden">
                    <div className="relative z-10">
                        <h2 className="text-2xl md:text-5xl font-bold mb-4 md:mb-6">Ready to transform your business?</h2>
                        <p className="text-white/80 mb-8 text-sm md:text-lg">Join 500+ hotel partners growing with My DESTINATION Hub today.</p>
                        <Link to="/hotel/join">
                            <button className="bg-white text-[var(--color-surface)] px-8 py-3.5 md:px-10 md:py-4 rounded-full font-bold text-sm md:text-base hover:bg-gray-100 hover:scale-105 transition-all">
                                List Your Property
                            </button>
                        </Link>
                    </div>
