...
const PartnerAbout = () => {
  ...
  const content =
    page?.content ||
    'My DESTINATION Partner is designed to help hotels, PGs and homestays manage inventory, bookings and payouts with a mobile-first dashboard.';
  const paragraphs = typeof content === 'string' ? content.split('\n').filter(Boolean) : [];

  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      <PartnerHeader title="About My DESTINATION Partner" subtitle="Platform overview" />
