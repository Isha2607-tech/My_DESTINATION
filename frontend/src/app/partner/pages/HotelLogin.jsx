...
const HotelLogin = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[var(--color-textDark)] via-[var(--color-surface)] to-[#006663] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    >
                        <img src={logo} alt="My DESTINATION Hub Partner" className="w-32 h-auto" />
                    </motion.div>
                    <h1 className="text-3xl font-bold text-white">Partner Login</h1>
                    <p className="text-sky-100 mt-2">Access your hotel dashboard</p>
                </div>
                            ...
                            >
                                ...
                                <div className="flex gap-2 mb-6 bg-gray-100 p-1 rounded-xl">
                                    <button
                                        ...
                                        className={`flex-1 py-2 px-4 rounded-lg font-medium transition-all ${method === 'phone'
                                            ? 'bg-[var(--color-surface)] text-white shadow-md'
                                            : 'text-gray-500'
                                            }`}
                                    >
                                ...
                                <form onSubmit={handleSendOTP} className="space-y-6">
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[var(--color-surface)] focus:border-transparent outline-none transition-all"
                                                required
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full bg-[var(--color-surface)] text-white py-3 rounded-xl font-bold shadow-lg hover:bg-[var(--color-textDark)] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                                    >
                                        {loading ? (
                            ...
                            >
                                <div className="text-center mb-6">
                                    <div className="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <Shield size={32} className="text-[var(--color-surface)]" />
                                    </div>
                                    ...
                                    <div className="flex gap-2 justify-center">
                                        {otp.map((digit, index) => (
                                            <input
                                                ...
                                                className="w-12 h-12 text-center text-xl font-bold border-2 border-gray-400 rounded-xl focus:border-[var(--color-surface)] focus:ring-2 focus:ring-sky-200 outline-none transition-all"
                                            />
                                        ))}
                                    </div>
                ...
                {/* Footer */}
                <p className="text-center text-sky-100 text-sm mt-6">
                    New partner?{' '}
                    <button
